...
TEST_USER_IS_STAFF_WORD = ('куратор', 'наставник', 'менеджер', 'ревью', 'продюсер сообществ', 'manager', 'support')
...
ALL_USERS_LIST = ['Виктор Цой', 'Юра Шатунов', 'Наставник Николай', 'Ревьювер Вова', 'Майкл Джексон', 'manager Roma']
